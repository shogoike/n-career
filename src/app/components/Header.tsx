      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/#features" className="text-gray-600 hover:text-blue-900 transition">特徴</Link>
            <Link href="/#services" className="text-gray-600 hover:text-blue-900 transition">サービス</Link>
            <Link href="/#results" className="text-gray-600 hover:text-blue-900 transition">実績</Link>
