        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur rounded-3xl border border-white/20 p-8">
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第1条（適用）</h2>
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第2条（サービス内容）</h2>
              <p className="text-green-100 leading-relaxed">
                当社は、以下のサービスを提供します。
              </p>
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第3条（利用登録）</h2>
              <p className="text-green-100 leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第4条（利用者の義務）</h2>
              <p className="text-green-100 leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第5条（禁止事項）</h2>
              <p className="text-green-100 leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第6条（サービスの変更・終了）</h2>
              <p className="text-green-100 leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第7条（免責事項）</h2>
              <p className="text-green-100 leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第8条（規約の変更）</h2>
              <p className="text-green-100 leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-xl font-bold text-white mb-4 pb-2 border-b border-white/20">第9条（準拠法・管轄裁判所）</h2>
              <p className="text-green-100 leading-relaxed">
